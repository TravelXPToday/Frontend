    ...
    return (
        <nav className="py-4 shadow-md border-b-4 bg-white border-teal-600 sticky top-0 z-20">
                ...
                <ul className="md:flex hidden space-x-4 mr- ">
                    <li><Link to="/" className="text-teal-600 hover:bg-rose-500 hover:text-white text-s font-semibold py-2 px-6 rounded-full transition duration-300 ease-in-out hover:drop-shadow-lg">Bestemmingen</Link></li>
                    <li><Link to="/"  className="text-teal-600 hover:bg-rose-500 hover:text-white text-s font-semibold py-2 px-6 rounded-full transition duration-300 ease-in-out hover:drop-shadow-lg">Blog</Link></li>
                    <li><Link to="/"  className="text-teal-600 hover:bg-rose-500 hover:text-white text-s font-semibold py-2 px-2 rounded-full transition duration-300 ease-in-out hover:drop-shadow-lg mr-10">Contact</Link></li>
                </ul>
                {/* Burger Menu */}
