        ...
        <div className="flex flex-col items-center ">
          <div className="relative inline-block">
            ...
            <div className="relative z-10">
              <h1 className="text-4xl font-bold mb-4 ">Welkom bij TravelXPToday!</h1>
              <p className="text-lg font-semibold mb-8">Ontdek de schoonheid van de wereld, deel je avonturen en leer van andere reizigers.</p>
            </div>
          </div>
